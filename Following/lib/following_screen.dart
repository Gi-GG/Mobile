...
class FollowingScreen extends StatelessWidget {
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      SizedBox(height: 16),
                      Text(
                        "Neutron is Following these awesome PPL  "
                            .toUpperCase(),
                        style: TextStyle(
                          color: Color(0XFFD5D5D5),
                          fontSize: 10.574533462524414,
                          fontFamily: 'Satoshi',
                          fontWeight: FontWeight.w700,
                        ),
                      ),
                      SizedBox(height: 12),
                      _buildListFollowing(context)
                    ],
                  ),
                ),
              )
  ...
  /// Section Widget
  Widget _buildStackFollowing(BuildContext context) {
    return SizedBox(
      height: 324,
      width: double.maxFinite,
      child: Stack(
  ...
  /// Section Widget
  Widget _buildListFollowing(BuildContext context) {
    return Expanded(
      child: Padding(
        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            return ListfollowingItemWidget();
          },
        ),
      ),
    );
...
class ListfollowingItemWidget extends StatelessWidget {
  const ListfollowingItemWidget({Key? key})
      : super(
          key: key,
        );
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        SizedBox(width: 12),
        _buildButtonFollowingGigg(context)
      ],
    );
  }

  /// Section Widget
  Widget _buildButtonFollowingGigg(BuildContext context) {
    return Container(
      width: double.maxFinite,
      height: 30,
